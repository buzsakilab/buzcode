function CCG_jitter_plotzerolag(ccgjitteroutput)
...
% psc = ccgjitteroutput(1).Connections0E;
...
for x = 1:size(ccgjitteroutput(1).Connections0E,1)

    a = ccgjitteroutput(1).Connections0E(x,1);
    b = ccgjitteroutput(1).Connections0E(x,2);
...
%% setting up plotting
    h = figure(ceil(x/25));
    figname=(['CCGZeroLagFig#',num2str(x)])
