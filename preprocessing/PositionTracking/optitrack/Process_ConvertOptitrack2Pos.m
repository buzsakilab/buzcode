...
%
% fbasename is name of the recording (folder and .dat file)
%
% defaults if args aren't given... assuming a single digitalin channel on Intan
...
for i = 1:2:length(varargin),
  ...
  switch(lower(varargin{i})),
    ...
    if exist([fbasename '.csv']) % assumes csv naming matches basename
