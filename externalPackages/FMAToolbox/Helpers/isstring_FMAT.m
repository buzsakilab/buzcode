%isstring_FMAT - Test if parameter is an (admissible) character string.
%
%  USAGE
%
%    test = isstring_FMAT(x,string1,string2,...)
%
%    x              item to test
...
if nargin < 1,
  error('Incorrect number of parameters (type ''help <a href="matlab:help isstring_FMAT">isstring_FMAT</a>'' for details).');
end
