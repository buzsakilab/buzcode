function [AssemblyTemplates, ZScoreThreshold, NonSignifAssemblyTemplates] = assembly_patterns_bw(SpikeCount,opts)
...
zSpikeCount = zscore(SpikeCount');%zscored per cell
