...
% fet,res,clu,spk files.  assumes a 16bit .dat, .xml file is present in 
% "basepath" (home folder) and  that they are named basename.dat and
% basename.xml. It assumes that your directory is structured as follow:
%
% ###
% .
% +-- _folder(basename)
...
% ###
%
% cluster_ids.npy and shanks.npy are generated by a phy plugin 
% -Export Shanks- found in the lab wiki)
%
% Inputs:
