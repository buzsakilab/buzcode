function [thresh,cross,bihist,dip,dip_p] = BimodalThresh(bimodaldata,varargin)
...
%   dip_p           p value for bimodal distribution
%
...
[dip, p_value]=hartigansdipsigniftest(bimodaldata,nboot)
