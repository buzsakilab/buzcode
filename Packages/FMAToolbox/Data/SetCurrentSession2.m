function SetCurrentSession2(filename)

%SetCurrentSession2 - Load all data for a given recording session.
%
% This is a modified version of SetCurrentSession() that defaults to
% Spotter's default video parameters when no video files are present.
