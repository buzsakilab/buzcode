function Q = MakeSummedValQfromS(S,bin,varargin)
% Binning of non-spike train tsdArray.  
% Differs from MakeQfromS by summating not simply numbers of events (as 
% used in spiketrain tsdArrays), rather summates values actual at those 
% events 
%  	
%  	USAGE:
...
% Modified by Brendon Watson 2015
...
nbCells = length(S.C); % Number of Cells
